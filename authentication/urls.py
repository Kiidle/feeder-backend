...
from . import views
from .views import (SignUpView, UserCommentariesView, UsersView,
                    UserUpdateGroupDetail, UserUpdateView, UserView,
                    UserWarnsView, WarnCreateView, assignmod, verify_user)
...
urlpatterns = [
    ...
    path(
        "users/<int:user_id>/warns/create", WarnCreateView.as_view(), name="warn_create"
    ),
